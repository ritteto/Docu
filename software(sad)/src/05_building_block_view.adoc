...
image::../../software(sad)/images/kontext_übersichtsdiagramm.jpg[Übersichtsdiagramm model]
...
image::../../software(sad)/images/catchorwaste_übersichtsdiagramm.jpg[Übersichtsdiagramm model]
...
image::../../software(sad)/images/view_übersichtsdiagramm.jpg[Übersichtsdiagramm model]
...
image::../../software(sad)/images/controller_übersichtsdiagramm.jpg[Übersichtsdiagramm model]
